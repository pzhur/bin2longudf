...
class Byte2ArrayTestSpark extends AnyFunSuite {
  ...
  val bs2longj = new binToLongJava
  val bs2intj = new binToIntJava
  val bs2shj = new binToShortJava
  val bs2bj = new binToByteJava
  val bs2doublej = new binToDoubleJava
  val bs2floatj = new binToFloatJava
  ...
  val bin2laUDFj: Unit = spark.udf.register("bin2laj", (x: Array[Byte]) => bs2longj.call(x))
  val bin2iaUDFj: Unit = spark.udf.register("bin2iaj", (x: Array[Byte]) => bs2intj.call(x))
  val bin2saUDFj: Unit = spark.udf.register("bin2saj", (x: Array[Byte]) => bs2shj.call(x))
  val bin2baUDFj: Unit = spark.udf.register("bin2baj", (x: Array[Byte]) => bs2bj.call(x))
  val bin2daUDFj: Unit = spark.udf.register("bin2daj", (x: Array[Byte]) => bs2doublej.call(x))
  val bin2faUDFj: Unit = spark.udf.register("bin2faj", (x: Array[Byte]) => bs2floatj.call(x))
  val n=10
  ...
  test("Byte2LongTest.Spark") {
    ...
    assert(makeDFandConvert[Long](a4sp, "bin2laj") === a)
  }
  ...
  test("Byte2IntTest.Spark") {
    ...
    assert(makeDFandConvert[Int](a4sp, "bin2iaj") === a)
  }
  test("Byte2ShortTest.Spark") {
    ...
    assert(makeDFandConvert[Short](a4sp, "bin2saj") === a)
  }
...
//  }
  ...
  test("Byte2DoubleTest.Spark") {
    ...
    assert(makeDFandConvert[Double](a4sp, "bin2daj") === a)
  }
  ...
  test("Byte2FloatTest.Spark") {
    ...
    assert(makeDFandConvert[Float](a4sp, "bin2faj") === a)
  }
